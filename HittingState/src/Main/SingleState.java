...
public class SingleState implements HittingState {
	HittingController controller;
	
	public SingleState(HittingController control) {
		controller = control;
	}
	...
	public void CompletedAtBat() {
		System.out.println("Hitter has completed their at-bat and ended up at 1st base");
		controller.setState(controller.getBenchState());
	}

	public String toString() {
		return HittingStateEnum.Single.toString();
	}
}
